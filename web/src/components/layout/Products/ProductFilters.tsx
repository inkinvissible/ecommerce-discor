    ...
    return (
        <div className="space-y-6 mb-6 bg-white rounded-xl p-5 shadow-sm border border-gray-100">
            ...
            <div className="relative mb-8">
                <div className={`relative transition-all duration-300 ${
                    ...
                    <Button
                        ...
                        disabled={isLoading}
                        className={`absolute left-2 top-1/2 transform -translate-y-1/2 h-10 w-10 p-0 rounded-full transition-colors duration-200 ${
                            isSearchFocused ? 'text-primary hover:bg-primary/10' : 'text-gray-400 hover:text-gray-600 hover:bg-gray-100'
                        }`}
                    >
                    ...
                    <Input
                        ...
                        disabled={isLoading}
                        className={`pl-12 pr-12 h-14 text-lg rounded-lg transition-all duration-200 ${
                            isSearchFocused
                    ...
                    {searchValue && (
                        <Button
                            ...
                            disabled={isLoading}
                            className="absolute right-2 top-1/2 transform -translate-y-1/2 h-10 w-10 p-0 rounded-full text-gray-400 hover:text-gray-600 hover:bg-gray-100"
                        >
                            <X className="w-5 h-5" />
                        </Button>
                    )}
                ...
                {totalResults > 0 && (
                    <div className="absolute -bottom-7 left-4 text-sm font-medium text-gray-500">
                ...
                {searchValue !== filters.search && searchValue.trim() !== '' && (
                    <div className="absolute -bottom-7 right-4 text-sm text-primary font-medium">
            ...
            <Collapsible open={isFiltersOpen} onOpenChange={setIsFiltersOpen} className="space-y-4">
                ...
                <CollapsibleContent className="transition-all duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 overflow-hidden">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-1 gap-6">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <Select
                                        ...
                                        disabled={isLoading}
                                    >
                                        <SelectTrigger className="h-auto min-h-[2.75rem] bg-white shadow-sm border-gray-200 rounded-lg">
                                            <SelectValue
